 ...
 * function pointers, not call OCI_Connect_standalone()/OCI_Disconnect_standalone()
 * directly, once db_driver_get() is wired into config.ini's db_type
 * (order-of-attack step 3, not done yet).
 */
