...
static ctx_config_map_t ctx_map[] = {
    ...
    { "worker_log_file_name",          CFG_STRING, offsetof(app_config_t, worker_log_file_name),          "worker_app.log", 0 },
    { "worker_log_file_max_size",      CFG_INT,    offsetof(app_config_t, worker_log_file_max_size),       NULL, 10485760 },
    { "worker_log_file_rotation_number", CFG_INT,  offsetof(app_config_t, worker_log_file_rotation_number),NULL, 5 },
    { "worker_log_level",              CFG_STRING, offsetof(app_config_t, worker_log_level),               "DEBUG", 0 },
        ...
        switch (m->type) {
            ...
            case CFG_STRING: {
                ...
                if (val) {
					...
					else if (!strcmp(m->name,"worker_log_level"))                  maxlen=sizeof(config->worker_log_level);
