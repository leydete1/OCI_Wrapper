...
/* 
   ...
   MODIFIED   (MM/DD/YY)
   apfwkr      11/13/25 - CI #38646829 of kdasaraj_oscid from main
   apfwkr      10/08/25 - CI #38512033 of shgangwa_bug-37653074 from main
   apfwkr      07/16/25 - CI #37957189 of siyuzha_bug-37214374 from main
   acolunga    07/01/25 - CI #38128393 of acolunga_bug-37811979 from main
   apfwkr      06/12/25 - CI #38069769 of rurabavi_bug-37913101 from main
   apfwkr      06/08/25 - CI #38047257 of karbitod_bug-37695567 from main
   sumkumar    05/31/25 - Bug xxxxxxxx: Add OCI_IGN_ALV_CLIENT
   kpkshirs    05/06/25 - XbranchMerge kpkshirs_bug-37143694 from main
   kpkshirs    05/05/25 - Bug 37907130: Change bit used by CQN PULL MODEL
   rurabavi    05/13/25 - Bug 37913101: Add OCI_ATTR_RESERVED_743 
   kdasaraj    10/22/25 - Bug 38366069: Add OTEL flags
   karbitod    05/07/25 - Bug 37695567: Add OCI_SRVATCH_RESERVED9 and 
                          OCI_SESSGET_NO_FAILOVER
   xzhzhou     04/29/25 - CI #37885094 of xzhzhou_bug-37196786 from main
   shgangwa    03/26/25 - Enh 37653074: add attributes for machine, osuser,
                          program, terminal
   acolunga    04/22/25 - Bug 37811979: add OCIJsonAnyType and decoders
   xzhzhou     03/31/25 - Bug 36952099: add OCI_ATTR_RESERVED_741/742
   sumkumar    03/29/25 - Bug 37758193: Add OCI_SRVATCH_RESERVED8
   bhgharu     03/24/25 - Project 104943: True Cache support for OCI
   ssubrama    03/12/25 - Bug 37698748: add remote bind
   apfwkr      02/27/25 - CI #37641529 of avnandak_proja-104769 from main
   karbitod    01/29/25 - Bug 36685432: Add OCI_ATTR_RESERVED_720-739
   siyuzha     01/21/25 - Bug 37214374: added OCI_ATTR_PING_TIMEOUT
   xzhzhou     01/21/25 - Bug 37196786: add OCI_ATTR_RESERVED_719
   siyuzha     01/21/25 - Bug 37214374: added OCI_ATTR_PING_TIMEOUT
   acolunga    01/13/25 - CI #37440535 of acolunga_bug-37202239 from main
   savsoni     12/10/24 - Bug 36394011: Added ReadOnly OCI_ATTR_ROUNDTRIP_COUNT
   kpkshirs    12/10/24 - Bug 37143694: Support pull notifications
   xzhzhou     01/21/25 - Bug 37196786: add OCI_ATTR_RESERVED_719
   savsoni     12/10/24 - Bug 36394011: Added ReadOnly OCI_ATTR_ROUNDTRIP_COUNT
   kpkshirs    12/10/24 - Bug 37143694: Support pull notifications
   apfwkr      11/16/24 - CI #37290695 of rkanodia_bug-36972130 from main
   mearumug    01/30/24 - Bug 37114851: Add contiguous sparse vector APIs
   avnandak    12/03/24 - Proj 104769: Add OCI_SPC_MULTI_TENANT
   kpkshirs    12/10/24 - Bug 37143694: Support pull notifications
   rpingte     11/15/24 - add sparse dimension count
   taranand    11/04/24 - Bug 37115068: Add sparse vector support
   sroesch     10/10/24 - CI# 37155067 of sroesch_bug-36258254 from main
   svhwang     08/28/24 - Bug 36996184: Rename Flex txn to Sessionless txn
   apfwkr      08/27/24 - CI# 36995948 of siyuzha_bug-36745130 from main
   acolunga    10/25/24 - Bug 37202239: OCI_FNCODE_JSONBINARYHASH 
   rkanodia    09/05/24 - Bug 36972130: OCI_ATTR_VECTOR_COL_PROPERTY_IS_SPARSE
   nikeda      08/26/24 - Bug 36817165: add private ATTR for SSS heap size
...
#define OCI_SUBSCR_QOS_PULL_NOTIFICATIONS  0x10000     /* Pull notifications */
...
#define OCI_SPC_MULTI_TENANT 0x0020                     /* Multi tenant pool */
#define OCI_SPC_TRUECACHE    0x0040                       /* True cache pool */
/*---------------------------------------------------------------------------*/
/*--------------------------- OCISessionGet Modes ---------------------------*/
...
#define OCI_SESSGET_NO_FAILOVER       0x1000  /* Session get w/ no failover  */

#define OCI_SESSGET_READ_ONLY         0x2000           /* strictly READONLY  */
#define OCI_SESSGET_READ_PREFER       0x4000           /* READONLY preferred */
#define OCI_SESSGET_RESERVED_1        0x8000           /* private get mode   */
/*---------------------------------------------------------------------------*/
...
#define OCI_SYSRAC          0x00100000           /* for SYSRAC authorization */
  /* Ignore ALLOWED_LOGON_VERSION_CLIENT setting for outbound DBLink connect */
#define OCI_IGN_ALV_CLIENT  0x00200000
...
#define OCI_SRVATCH_RESERVED8 0x08000000                         /* reserved */
#define OCI_SRVATCH_RESERVED9 0x10000000                         /* reserved */
...
#define OCI_ATTR_VECTOR_COL_PROPERTY_IS_SPARSE      0x02
...
/* The below mode is for OCIVectorSparse APIs only */
#define OCI_VECTOR_SPARSE_CONTIGUOUS        0x01
...
#define OCI_ATTR_RESERVED_713                   713
#define OCI_ATTR_RESERVED_714                   714
#define OCI_ATTR_RESERVED_715                   715
#define OCI_ATTR_NUMBER_PROPERTY                716
                                                 /* NUMBER datatype property */
#define OCI_ATTR_VECTOR_SPARSE_DIMENSION        717
                                          /* Sparse dimension of vector type */
#define OCI_ATTR_ROUNDTRIP_COUNT                718                                   
#define OCI_ATTR_RESERVED_719                   719
#define OCI_ATTR_RESERVED_720                   720
#define OCI_ATTR_RESERVED_721                   721
#define OCI_ATTR_RESERVED_722                   722
#define OCI_ATTR_RESERVED_723                   723
#define OCI_ATTR_RESERVED_724                   724
#define OCI_ATTR_RESERVED_725                   725
#define OCI_ATTR_RESERVED_726                   726
#define OCI_ATTR_RESERVED_727                   727
#define OCI_ATTR_RESERVED_728                   728
#define OCI_ATTR_RESERVED_729                   729
#define OCI_ATTR_RESERVED_730                   730
#define OCI_ATTR_RESERVED_731                   731
#define OCI_ATTR_RESERVED_732                   732
#define OCI_ATTR_RESERVED_733                   733
#define OCI_ATTR_RESERVED_734                   734
#define OCI_ATTR_RESERVED_735                   735
#define OCI_ATTR_RESERVED_736                   736
#define OCI_ATTR_RESERVED_737                   737
#define OCI_ATTR_RESERVED_738                   738
#define OCI_ATTR_RESERVED_739                   739
#define OCI_ATTR_PING_TIMEOUT                   740          /* ping timeout */
#define OCI_ATTR_RESERVED_741                   741
#define OCI_ATTR_RESERVED_742                   742
#define OCI_ATTR_RESERVED_743                   743
#define OCI_ATTR_RESERVED_744                   744
#define OCI_ATTR_RESERVED_745                   745
#define OCI_ATTR_TRUECACHE_SERVICENAME          746
#define OCI_ATTR_RESERVED_747                   747
#define OCI_ATTR_RESERVED_748                   748
#define OCI_ATTR_MACHINE                        749          /* machine name */
#define OCI_ATTR_OSUSER                         750           /* os username */
#define OCI_ATTR_PROGRAM                        751          /* program name */
#define OCI_ATTR_TERMINAL                       752              /* terminal */
#define OCI_ATTR_OTEL_OPTIONS                   766   /* parameters for OTEL */
#define OCI_ATTR_LAST                           766
...
/* CQN PULL MODEL */
/* We are re using the callback name field for storing the pull model queue
 * name. Callback name field is unused for client-initiated connections. So
 * it is safe to reuse. To achieve this, we are simply defining the below macro
 */
#define OCI_ATTR_CHNF_PULL_QUEUE_NAME             OCI_ATTR_SUBSCR_PAYLOADCBK
...
#define OCI_FNCODE_SUBSCRIPTION_REGISTER  247     /* OCISubscriptionRegister */
#define OCI_FNCODE_SUBSCRIPTION_UNREGISTER 248    /* OCISubscriptionRegister */
#define OCI_FNCODE_VECTOR_FROM_SPARSE_ARRAY 249  /* OCIVectorFromSparseArray */
#define OCI_FNCODE_VECTOR_TO_SPARSE_ARRAY 250      /* OCIVectorToSparseArray */      
#define OCI_FNCODE_JSONBINARYHASH         251           /* OCIJsonBinaryHash */
#define OCI_FNCODE_JSONANYTYPE            252              /* OCIJsonAnyType */
#define OCI_FNCODE_JSONDECODEANYTYPEBSON  253  /* OCIJsonDecodeAnyTypeToBson */
#define OCI_FNCODE_JSONDECODEANYTYPETEXT  254  /* OCIJsonDecodeAnyTypeToText */
#define OCI_FNCODE_JSONDECODEANYTYPEEJSON 255
                                            /* OCIJsonDecodeAnyTypeToExtText */
#define OCI_FNCODE_JSONDECODEANYTYPEOSON  256 
                                             /* OCIJsonDecodeAnyTypeToBinary */
#define OCI_FNCODE_MAXFCN                 256   /* maximum OCI function code */
