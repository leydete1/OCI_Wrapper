 ...
 *    
 * MODIFIED
 *    bwolfgan   03/26/25 - Rename OQS into PQC
 *    bwolfgan   10/11/24 - Add OQS support
...
enum nzttCipherType 
{
   ...
   /* PQC cipher needs to be equal or bigger than 0x100 */
   NZTTCIPHERTYPE_ML_DSA   = 0x100,  /*!< ML_DSA */
   NZTTCIPHERTYPE_SLH_DSA  = 0x101   /*!< SLH_DSA */
};
typedef enum nzttCipherType nzttCipherType;

#define NZTTCIPHERTYPE_isPQC(c) (c >= 0x100)
