...
/* 
   ...
   MODIFIED   (MM/DD/YY)
   apfwkr      09/22/25 - CI #38459724 of dmcmahon_bov250609 from main
   ...
   dmcmahon    07/23/25 - Bug 38233041: JZNERR_PATH_PATH_FUNC_MATCH
   prthiaga    06/17/25 - Bug 38086755: Add JZNERR_BOV_CANNOT_EDIT_KEY
   dmcmahon    06/11/25 - Bug 38058437: BOV errors related to scalar tables
   ...
   dmcmahon    05/13/23 - Bug 35378595: Flexfield run-time errors
   dmcmahon    05/12/23 - Bug 35383407: JZNERR_PATH_PATH_BAD_FUNC
...
#define JZNERR_PATH_PATH_FUNC_MATCH   276
...
#define JZNERR_ARRAY_TOO_MANY_DIMENSIONS  582               /* %u dimensions */
#define JZNERR_ARRAY_BAD_DIMENSION        583  /* dimension value %u invalid */
...
#define JZNERR_BOV_BAD_SCALAR_LINK    649
...
#define JZNERR_BOV_ONE_VISIBLE_COL    693 /* ~s must have one visible column */
#define JZNERR_BOV_LINK_KEYNAME       694
#define JZNERR_BOV_CANNOT_EDIT_KEY    695    /* cannot ins/upd write aug key */
