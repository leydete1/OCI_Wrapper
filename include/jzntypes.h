...
/*
   ...
   dmcmahon    10/01/25 - Bug 38477861: JZNVAL_ORA_BOOLEAN collation type
   dmcmahon    06/04/25 - Bug 38030020: JZNVAL_NUMBER_FIXED
   dmcmahon    04/28/25 - Bug 37898144: JZNVAL_ROWID carrier type
   zliu        01/13/25 - Bug 37486754: move JZNU_MAX_ORA_TYPE_LEN from jzn.h
   dmcmahon    11/05/24 - Bug 37249695: Add types for short integers/floats
...
#define JZN_ORA_ROWID_LEN            10  /* New Oracle 8 ROWID */
#define JZN_ORA_ROWID7_LEN           8   /* Old Oracle 7 ROWID */
#define JZN_ORA_NUM11_LEN            11

#define JZN_ROWID_STR_LEN            18
...
** JSON Value types
**
**  Type name                   Usage       Representation    JSON    SQL
**  -----------------------------------------------------------------------
**  JZNVAL_UNKNOWN              signal      n/a               n/a
**  JZNVAL_NONE                 signal      n/a               n/a
**  JZNVAL_NULL                 OSON        in-line           yes     yes
**  JZNVAL_STRING               OSON        pointer+length    yes     yes
**  JZNVAL_NUMBER               model       pointer+length    yes
**  JZNVAL_FALSE                OSON        in-line           yes
**  JZNVAL_TRUE                 OSON        in-line           yes     yes
**  JZNVAL_BINARY               OSON        pointer+length
**  JZNVAL_ORA_NUMBER           OSON        pointer+length            yes
**  JZNVAL_ORA_DATE             OSON        pointer+length            yes
**  JZNVAL_ORA_TIMESTAMP        OSON        pointer+length            yes
**  JZNVAL_ORA_TIMESTAMPTZ      OSON        pointer+length            yes
**  JZNVAL_ORA_YEARMONTH_DUR    OSON        pointer+length            yes
**  JZNVAL_ORA_DAYSECOND_DUR    OSON        pointer+length            yes
**  JZNVAL_SINT_ORANUM          OSON        pointer+length            yes*
**  JZNVAL_SLONG_ORANUM         OSON        pointer+length            yes*
**  JZNVAL_DEC128BID_ORANUM     OSON        pointer+length            yes*
**  JZNVAL_CANONICAL_FLOAT      OSON        pointer+length            yes
**  JZNVAL_CANONICAL_DOUBLE     OSON        pointer+length            yes
**  JZNVAL_ORA_BOOLEAN          model       pointer+length            yes
**  JZNVAL_ID                   OSON        pointer+length            yes*
**  JZNVAL_VECTOR               OSON        pointer+length            yes*
**  JZNVAL_ROWID                model       in-line                   yes
**  JZNVAL_SINT                 model       in-line
**  JZNVAL_SLONG                model       in-line
**  JZNVAL_UINT                 model       in-line
**  JZNVAL_ULONG                model       in-line
**  JZNVAL_FLOAT                model       in-line
**  JZNVAL_DOUBLE               model       in-line
**  JZNVAL_TSTAMP               model       in-line
**  JZNVAL_OID                  model       in-line
**  JZNVAL_UUID                 model       in-line
**  JZNVAL_DEC128BID            model       in-line
**  JZNVAL_DEC64BID             model       in-line
**  JZNVAL_SHORT                model       in-line
**  JZNVAL_USHORT               model       in-line
**  JZNVAL_FLOAT16              model       in-line
**  JZNVAL_BFLOAT16             model       in-line
**  JZNVAL_OPAQUE               carrier     n/a
**  JZNVAL_CLOB                 carrier     n/a
**  JZNVAL_BLOB                 carrier     n/a
**  JZNVAL_ORA_TIME             carrier     n/a
**  JZNVAL_OCI_NUMBER           carrier     n/a
**  JZNVAL_OCI_DATE             carrier     n/a
**  JZNVAL_OCI_DATETIME         carrier     n/a
**  JZNVAL_OCI_STRING           carrier     n/a
**  JZNVAL_OCI_RAW              carrier     n/a
**  JZNVAL_BASE64               carrier     n/a
**  JZNVAL_OCI_INTERVAL         carrier     n/a
**  JZNVAL_ANY_TYPE             carrier     n/a
**  JZNVAL_ANSI_DATE            carrier     n/a
**  JZNVAL_DOC_NODE             carrier     n/a
**  JZNVAL_VEC_STREAM           carrier     n/a
**  JZNVAL_ARR_STREAM           carrier     n/a
**  JZNVAL_SCALAR_ARRAY         carrier     n/a
**  JZNVAL_NUMBER_FIXED         carrier     n/a
**  JZNVAL_NUMBER64             carrier     n/a
**
**  Types listed as "model" are part of the internal JSON data model and
**  can appear in event sources and mutable DOM nodes. Types listed as "OSON"
**  are also "model" types, but these can be stored in OSON images. Types
**  listed as "signal" are used for special cases (e.g. key events, container
**  events) in the JSON event model and cannot otherwise be used. Types listed
**  as "carrier" can only be used in some internal and/or DOM APIs to
**  convey a type into the system after which it's converted to a model type.
**
**  Some model types are stored in-line, while others are stored out-of-line
**  using a (pointer, length) combination.
**
**  The JSON and SQL properties indicate whether the type is native to the
**  JSON type system or the Oracle SQL column type system. A '*' in the SQL
**  column indicates that the type is a flagged version of a native SQL type.
*/
typedef enum jznvaltype
{
    ...
    */
     ...
     * throughout its RDBMS/OCI stack, then we can revisist this.
     *
    ...
    */
    ...
    /* Extensions for SMALLINT, 16-bit floats */
    JZNVAL_SHORT             = 51, /* 2-byte signed short integer     */
    JZNVAL_USHORT            = 52, /* 2-byte unsigned short integer   */
    JZNVAL_FLOAT16           = 53, /* 2-byte canonical IEEE 754 float */
    JZNVAL_BFLOAT16          = 54, /* 2-byte canonical bfloat16       */

    /* More marker types */
    JZNVAL_NUMBER_FIXED      = 30, /* 11-byte OraNum in ub1[] format  */
    JZNVAL_NUMBER64          = 50, /* 16-digit OraNum in ub8 format   */
    JZNVAL_ROWID             = 55  /* Oracle ROWID */
    /*
...
typedef enum jznCollationType
{
   ...
   /* Specialized types for preserve mode */
   JZNCOLLATION_SHORT           = 65,
   JZNCOLLATION_USHORT          = 66,
   JZNCOLLATION_SINT            = 67,
   JZNCOLLATION_UINT            = 68,
   JZNCOLLATION_SLONG           = 69,
   JZNCOLLATION_ULONG           = 70,
   JZNCOLLATION_FLOAT           = 71,
   JZNCOLLATION_DOUBLE          = 72,
   JZNCOLLATION_DATE            = 73,
   /* Types up to 127 reserved for simple scalars */

   JZNCOLLATION_VECTOR          = 128, /* vector or array */

   /* 224 - 239 reserved for binary terminators */
...
#define JZN_BSON_BIN_SUBTYPES
    ...
    union integer_value /* Value information (if signed long/int) */
    {
      ...
      sb2      shortval; /* If a 16-bit value */
    } ival;
    union unsigned_value /* Value information (if unsigned long/int) */
    {
      ub8      longval;  /* If a 64-bit value */
      ub4      intval;   /* If a 32-bit value */
      ub2      shortval; /* If a 16-bit value */
    } uval;
    union half_value     /* Value information (for 16-bit floats) */
    {
      ub2      float16;  /* IEEE 754 16-bit float */
      ub2      bfloat16; /* Google 16-bit float   */
    } hval;
...
#define JZNBOV_VEC_BFLOAT 6 /*            - bfloat16 */
...
/*
** Maximum size of an Oracle scalar type for
**   Oracle Number (21)
**   Oracle Timestamp with time zone (13)
**   Oracle interval types (5) and (11)
**   Binary Double (8)
** Also
**   UUID (16)
**   OID (12)
*/
#define JZNU_MAX_ORA_TYPE_LEN 32
